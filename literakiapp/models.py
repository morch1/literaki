...
class Game(models.Model):
    ...
    letters = models.CharField(max_length=100, default='a' * 9 + 'ą' + 'b' * 2 + 'c' * 3 + 'ć' + 'd' * 3 + 'e' * 7 + 'ę' * 1 + 'f' * 1 + 'g' * 2 + 'h' * 2 + 'i' * 8 + 'j' * 2 + 'k' * 3 + 'l' * 3 + 'ł' * 2 + 'm' * 3 + 'n' * 5 + 'ń' + 'o' * 6 + 'ó' + 'p' * 3 + 'r' * 4 + 's' * 4 + 'ś' + 't' * 3 + 'u' * 2 + 'w' * 4 + 'y' * 4 + 'z' * 5 + 'ź' + 'ż' + ' ' * 2)
